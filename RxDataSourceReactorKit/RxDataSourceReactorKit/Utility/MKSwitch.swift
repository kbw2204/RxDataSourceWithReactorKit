...
class MKSwitch: UIControl {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            self.widthAnchor.constraint(equalToConstant: 29),
        ...
        NSLayoutConstraint.activate([
            track.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.86),
        ...
        NSLayoutConstraint.activate([
            thumb.heightAnchor.constraint(equalTo: self.heightAnchor, multiplier: 0.9),
